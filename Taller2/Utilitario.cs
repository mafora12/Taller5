...
namespace Utilitario1 {
        ...
        public static string[] SepararCadena(string cadena, char separador)
    {
        ...
        {
            return new string[0]; // Retorna un array vacío si la cadena está vacía o es nula
        }
        ...
        public static string TruncarTexto(string cadena,int total_caracteres)
        {
         ...
         // Función para procesar cada registro, dividiéndolo según el delimitador.
